...
// ── Main tab navigator with custom floating bar ─────────────
function MainTabs() {
  return (
    <Tab.Navigator
      ...
      tabBar={({ state, navigation }) => {
        ...
        const active = idMap[route.name] || 'Home';
        return (
          <TabBar
            active={active}
            onChange={(id) => {
